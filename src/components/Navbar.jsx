function Navbar(){
    return(
        <div className='relative'>
            ...
            <ul className='relative flex z-10 justify-between items-center h-24 max-w-[1240px] font-bold mx-auto px-4 pt-10 text-[#FA6B1C] md:text-4xl sm:text-3xl text-2xl'>
